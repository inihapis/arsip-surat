...
if (isset($_POST['cetak'])) {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
        ...
        <body>
            ...
            <div style="margin-top:-100px;margin-left:30px;margin-bottom:5px">
            ...
            <!-- <div id="isi"> -->
                <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                    ...
                    $result = $mysqli->query("SELECT a.id_surat_masuk,a.jenis,a.tanggal_diterima,a.asal_surat,a.nomor_surat,a.tanggal_surat,a.perihal,a.keterangan,b.id_instansi,b.nama_instansi,c.nama_jenis
                                              FROM surat_masuk as a INNER JOIN instansi as b INNER JOIN jenis as c ON a.asal_surat=b.id_instansi AND a.jenis=c.id_jenis
