...
// jika user sudah login
    ...
    if ($_GET['form']=='add') { ?>
        <!--<script type="text/javascript">
            function enabledisabletext() {
                ...
                {
                    document.frmSuratMasuk.jenis.readOnly=true;
                }
                if(document.frmSuratMasuk.generate_nomor.value=='Tidak')
                {
                    document.frmSuratMasuk.jenis.readOnly=false;
                }
            }
        </script>-->
    ...
    elseif ($_GET['form']=='detail') { 
        if (isset($_GET['id'])) {
            ...
            $result = $mysqli->query("SELECT a.id_surat_masuk,a.jenis,a.tanggal_diterima,a.asal_surat,a.nomor_surat,a.tanggal_surat,a.sifat_surat,a.perihal,a.keterangan,a.arsip,a.created_user,a.created_date,b.id_instansi,b.nama_instansi,c.userID,c.user_account_name,d.nama_instansi,e.nama_jenis
                                      FROM surat_masuk as a INNER JOIN instansi as b INNER JOIN sys_users as c INNER JOIN instansi as d INNER JOIN jenis as e
                                      ON a.asal_surat=b.id_instansi AND a.created_user=c.userID AND a.asal_surat=d.id_instansi AND a.jenis=e.id_jenis 
    ...
    elseif ($_GET['form']=='edit') { 
    	if (isset($_GET['id'])) {
    		$id_surat_masuk = $_GET['id'];
            // fungsi query untuk menampilkan data dari tabel surat_masuk
            $result = $mysqli->query("SELECT a.id_surat_masuk,a.jenis,a.tanggal_diterima,a.asal_surat,a.nomor_surat,a.tanggal_surat,a.sifat_surat,a.perihal,a.keterangan,a.arsip,b.id_instansi,b.nama_instansi
