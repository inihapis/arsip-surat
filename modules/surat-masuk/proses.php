    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            if (empty($nama_file)) {
                ...
                $insert = $mysqli->query("INSERT INTO surat_masuk(id_surat_masuk,jenis,tanggal_diterima,asal_surat,nomor_surat,tanggal_surat,sifat_surat,perihal,keterangan,created_user)
                                          VALUES('$id_surat_masuk','$jenis','$tanggal_diterima','$asal_surat','$nomor_surat','$tanggal_surat','$sifat_surat','$perihal','$keterangan','$created_user')")
                ...
                if(in_array($extension, $allowed_extensions)) {
                    ...
                    if($ukuran_file <= 5000000) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 5MB
                        ...
                        if(move_uploaded_file($tmp_file, $path)) { // Cek apakah file berhasil diupload atau tidak
                            ...
                            // perintah query untuk menyimpan data ke tabel surat masuk
                            $insert = $mysqli->query("INSERT INTO surat_masuk(id_surat_masuk,jenis,tanggal_diterima,asal_surat,nomor_surat,tanggal_surat,sifat_surat,perihal,keterangan,arsip,created_user)
                                                      VALUES('$id_surat_masuk','$jenis','$tanggal_diterima','$asal_surat','$nomor_surat','$tanggal_surat','$sifat_surat','$perihal','$keterangan','$arsip','$created_user')")
                                                      or die('Ada kesalahan pada query insert : '.$mysqli->error); 
