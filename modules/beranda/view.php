                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="media">
                                ...
                                <?php  
                                $tahun = date("Y");
                                // fungsi query untuk menampilkan jumlah seluruh surat masuk
                                $result = $mysqli->query("SELECT count(id_surat_masuk) as jumlah FROM surat_masuk")
                                ...
                                ?>
                                    ...
                                    <span><strong>Surat Masuk</strong> <br> Seluruh</span>
                                </div>
                                <div class="media-right media-middle">
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="media">
                                <div class="media-body text-xs-left">
                                <?php  
                                // fungsi query untuk menampilkan jumlah surat masuk per tahun berjalan
                                $result = $mysqli->query("SELECT count(id_surat_masuk) as jumlah FROM surat_masuk WHERE LEFT(tanggal_diterima,4)='$tahun'")
                                ...
                                ?>
                                    ...
                                    <span><strong>Surat Masuk</strong> <br> Tahun <?php echo $tahun; ?></span>
                                </div>
                                <div class="media-right media-middle">
                    ...
                    <div style="margin-top:-10px;" class="card-body">
                        <div class="card-block-login">
                            <table class="profil-instansi">
                                ...
                                <tr>
                                    <td width="25" valign="middle"><i class="icon-whatsapp"></i></td>
