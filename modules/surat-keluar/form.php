...
// jika user sudah login
    ...
    if ($_GET['form']=='add') { ?>
        <!--<script type="text/javascript">
            function enabledisabletext() {
                ...
                {
                    document.frmSuratKeluar.jenis.readOnly=true;
                }
                if(document.frmSuratKeluar.generate_nomor.value=='Tidak')
                {
                    document.frmSuratKeluar.jenis.readOnly=false;
                }
            }
        </script>-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div style="margin-bottom: 0.5rem;" class="form-group">
                                                        ...
                                                        <select class="form-control" id="select-jenis" name="jenis" autocomplete="off" required>
                                                            <option value=""></option>
                                                            <?php
                                                            // sql statement untuk menampilkan data dari tabel jenis
                                                            $query_jenis = $mysqli->query("SELECT id_jenis, nama_jenis FROM jenis ORDER BY nama_jenis ASC")
                                                                                            or die('Ada kesalahan pada query tampil data jenis: '.$mysqli->error);
                                                            // tampilkan data
                                                            while ($data_jenis = $query_jenis->fetch_assoc()) {
    ...
    elseif ($_GET['form']=='detail') { 
        if (isset($_GET['id'])) {
            ...
            $result = $mysqli->query("SELECT a.id_surat_keluar,a.jenis,a.tanggal_register,a.tujuan_surat,a.nomor_surat,a.tanggal_surat,a.perihal,a.keterangan,a.arsip,a.created_user,a.created_date,b.id_jenis,b.nama_jenis,c.userID,c.user_account_name,d.nama_instansi,e.nama_jenis
                                      FROM surat_keluar as a INNER JOIN jenis as b INNER JOIN sys_users as c INNER JOIN instansi as d INNER JOIN jenis as e
                                      ON a.tujuan_surat=b.id_jenis AND a.created_user=c.userID AND a.tujuan_surat=d.id_instansi AND a.jenis=e.id_jenis
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                                            <div class="table-responsive">
                                                <table class="table table-hover mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-truncate">Jenis Surat</td>
                                                            <td class="text-truncate">:</td>
                                                            <td class="text-truncate"><?php echo $data['nama_jenis']; ?></td>
                                                        </tr>
                                                        <tr>
    ...
    elseif ($_GET['form']=='edit') { 
    	if (isset($_GET['id'])) {
    		$id_surat_keluar = $_GET['id'];
            // fungsi query untuk menampilkan data dari tabel surat_keluar
            $result = $mysqli->query("SELECT a.id_surat_keluar,a.jenis,a.tanggal_register,a.tujuan_surat,a.nomor_surat,a.tanggal_surat,a.perihal,a.keterangan,a.arsip,b.id_jenis,b.nama_jenis
                                      FROM surat_keluar as a INNER JOIN jenis as b ON a.tujuan_surat=b.id_jenis
                                      WHERE a.id_surat_keluar='$id_surat_keluar'") 
                                      or die('Ada kesalahan pada query tampil data detail : '.$mysqli->error);
            $data = $result->fetch_assoc();
      	}
