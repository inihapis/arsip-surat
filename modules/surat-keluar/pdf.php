...
if (isset($_POST['cetak'])) {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
        ...
        <body>
            ...
            <style>
                /* Tambahkan jarak sebelum <hr> */
                hr {
                    margin-top: 20px; /* Jarak vertikal atas sebelum garis horizontal */
                    margin-bottom: 10px; /* Jarak bawah setelah garis horizontal */
                }

                /* Tambahkan jarak sebelum <br> */
                .spasi-antar {
            ...
            <div id="title">
            <!--PT. LANGGENG INOVASI TEKNOLOGI <!- RUBAH KOPSURAT -->
            </div>
            <div id="title">
            <!--INDONESIA <!- RUBAH KOPSURAT -->
            </div>
            <div id="title-bapas">
            ...
            <div id="title-tanggal">
                Telp. <?php echo $data_config['telepon']; ?>, Whatsapp. <?php echo $data_config['fax']; ?>
            </div>
            <div style="margin-top:-100px; padding-left:30px; margin-bottom:5px">
                <img src="../../assets/images/logo-instansi/LOGO_KOP_SURAT.png" alt="Logo" width="80">
            </div>
            <hr><br>
            <div id="title">
                ...
                <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                    <thead style="background:#e8ecee">
                        <tr class="tr-title">
                            ...
                            <th height="25" align="center" valign="middle">JENIS SURAT</th>
                    ...
                    $result = $mysqli->query("SELECT a.id_surat_keluar,a.jenis,a.tanggal_register,a.tujuan_surat,a.nomor_surat,a.tanggal_surat,a.perihal,a.keterangan,b.id_instansi,b.nama_instansi,c.nama_jenis
                                              FROM surat_keluar as a INNER JOIN instansi as b INNER JOIN jenis as c ON a.tujuan_surat=b.id_instansi AND a.jenis=c.id_jenis
                    ...
                    if ($rows > 0) {
                        while ($data = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td width="115" height="17" align="center" valign="middle"><?php echo $data["nama_jenis"]; ?></td>
