...
if (isset($_POST['export'])) {
	...
	<center>
		<h3><!--PT. LANGGENG INOVASI TEKNOLOGI<br> <!- RUBAH KOPSURAT -->
		<!--INDONESIA<br> <!- RUBAH KOPSURAT -->
		<?php echo strtoupper($data_config['nama_instansi']); ?> <br>
		<?php echo $data_config['alamat']; ?> <br>
		Telp. <?php echo $data_config['telepon']; ?>, Whatsapp. <?php echo $data_config['fax']; ?> <br>
		</h3>
		<h3>
		...
		<h3>
			<thead>
				<tr>
                    ...
                    <th align="center" valign="top">JENIS SURAT</th>
        ...
        if ($rows > 0) {
            while ($data = $result->fetch_assoc()) { ?>
				<tr>
				    ...
				    <td align="center" valign="top"><?php echo $data['nama_jenis']; ?></td>
	...
	<table>
		<tr>
			...
			<td align="center" valign="top"></td>
			<td align="center" valign="top"></td>
			<td align="center" valign="top">......................., <?php echo tgl_eng_to_ind("$hari_ini"); ?></td>
		</tr>
		<tr>
			<td align="center" valign="top"></td>
			<td align="center" valign="top"></td>
