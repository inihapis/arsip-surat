...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        ...
        <style>
            /* Atur ukuran font lebih kecil untuk elemen yang diinginkan */
            #title-bapas {
                font-size: 20px; /* Ubah nilai sesuai kebutuhan */
            }

            #title-alamat {
                font-size: 11px; /* Ubah nilai sesuai kebutuhan */
            }

            #title-tanggal {
                font-size: 11px; /* Ubah nilai sesuai kebutuhan */
            }
            /* Atur ukuran logo agar proporsional dengan teks */
            .logo-container img {
                width: 60px; /* Ukuran yang disesuaikan */
                height: auto; /* Memastikan proporsi logo tetap terjaga */
            }
        </style>
        ...
        <div style="margin-top:-100px;margin-bottom:5px;margin-left:10px">
            <img src="../../assets/images/logo-instansi/LOGO_KOP_SURAT.png" alt="Logo" width="85">
        </div>
        <hr><br>
        <div id="title">
