       ...
       <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div class="flex-1 px-8 bg-white divide-y space-y-1">
             <ul class="space-y-1 pb-2">
               ...
               <li>
               <a href="{{ route('dashboard') }}" wire:navigate class="transition-all duration-200 text-base text-gray-900 font-normal rounded-lg flex items-center p-2 {{ request()->routeIs('dashboard') ? 'active' : ' hover:bg-blue-100 hover:text-primary' }}">
               ...
               <a href="{{ route('outgoing-letter.index') }}" class="transition-all duration-200 text-base text-gray-900 font-normal rounded-lg flex items-center p-2 {{ request()->routeIs('outgoing-letter.index') ? 'active' : ' hover:bg-blue-100 hover:text-primary' }}">
                ...
                <li>
                   <a href="#" target="_blank" class="transition-all duration-200 text-base text-gray-900 font-normal rounded-lg flex items-center p-2 {{ request()->routeIs('dashboard') ? 'active' : ' hover:bg-blue-100 hover:text-primary' }}">
               ...
               <li class="pt-6 pt-1">
                ...
                <li>
                   <a href="{{ route('institution.index') }}" wire:navigate class=" transition-all duration-200 text-base text-gray-900 font-normal rounded-lg  flex items-center p-2 {{ request()->routeIs('institution.index') ? 'active' : ' hover:bg-blue-100 hover:text-primary' }}">
                     <i class="ti ti-building text-2xl"></i>
                     <span class="ml-3 flex-1 whitespace-nowrap">Instansi</span>
                   </a>
                </li>
                <li>
