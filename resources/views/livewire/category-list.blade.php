        ...
        var table = $('#dataTable').DataTable({
            ...
            columns: [
                ...
                { data: null, render: function(data, type, row) {
                    return '<button type="submit" class="btn-icon-action tippy-button" data-tippy-content="Edit Data"" onclick="editKategori(' + row.id + ')">' +
                   '<i class="ti ti-edit"></i>' +
                   '</button>' +
                   '<button type="submit" class="btn-icon-actionDelete tippy-button" data-tippy-content="Hapus Data" onclick="confirmDeleteKategori(' + row.id + ')">' +
