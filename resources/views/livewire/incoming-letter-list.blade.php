...
@section('title', 'Surat Masuk')
                ...
                <div class="py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-100">
                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <!-- Tombol Tambah -->
                            <x-button onclick="addSuratMasuk()"><i class="ti ti-circle-plus"></i>Tambah Surat Masuk</x-button>
                        </div>
                    </div>
                </div>
                <!-- End Header -->
                    ...
                    <div class="bg-white overflow-hidden rounded-lg shadow-lg w-11/12 md:w-1/2">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-y-8 gap-x-4">
                                ...
                                <div>
                                    <span class="block text-lg font-extrabold text-gray-700">Pengirim</span>
                ...
                <div id="modal" class="fixed inset-0 z-50 bg-gray-800 bg-opacity-50 hidden  items-center justify-center">
                    <div class="bg-white overflow-hidden rounded-lg shadow-lg w-11/12 md:w-1/2">
                        ...
                        <form id="modal-form" class="grid grid-cols-2 gap-4" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label for="select-institution" class="block text-sm font-bold text-gray-700">Asal Surat</label>  
                                <div class="w-full mt-1">
                                <!-- Select -->
    ...
    $(document).ready(function() {
        ...
        var table = $('#dataTable').DataTable({
            ...
            order: [1, 'desc'],
            ajax: {
                url: "{{ route('incoming-letter.data') }}",
                data: function(d) {
                    d.draw = d.draw;
                    d.start = d.start;
                    d.length = d.length;
            ...
            columns: [
                ...
                { data: null, name: 'subject_description',
                    render: function(data, type, row) {  
                        return '<span class="font-extrabold">' + row.subject + ',</span> <br>' + row.description; 
                    },  
                },   
            ...
            columnDefs: [
                ...
                {
                    targets: [1, 2, 3], // Indeks kolom yang ingin ditambahkan kelas p-3
                    createdCell: function(td, cellData, rowData, row, col) {
        ...
        $(document).on('submit', '#modal-form', function(e) {
            ...
            $.ajax({    
                url: id ? `/incoming-letter/update/${id}` : '/incoming-letter/store',    
                method: 'POST',    
                data: formData,    
                processData: false,    
                contentType: false,    
