...
// jika user sudah login
    ...
    if ($_SESSION['sias_user_permissions']=='Administrator') { ?>
        ...
        <?php
        // jika menu jenis dipilih, menu jenis aktif
        if ($_GET["module"] == "jenis" || $_GET["module"] == "form_jenis") { ?>
            <li class="active nav-item">
                <a href="jenis"><i class="icon-file-text2"></i><span class="menu-title">Jenis Surat</span></a>
            </li>
        <?php
        } 
        // jika tidak, menu jenis tidak aktif
        else { ?>
            <li class=" nav-item">
                <a href="jenis"><i class="icon-file-text2"></i><span class="menu-title">Jenis Surat</span></a>
            </li>
