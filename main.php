...
// jika user sudah login
    ...
    <html lang="en" data-textdirection="ltr" class="loading">
        <head>
            ...
            <meta name="description" content="Sistem Informasi Administrasi Surat Masuk dan Surat Keluar">
            <meta name="keywords" content="Sistem Informasi Administrasi Surat Masuk dan Surat Keluar">
            ...
            // jika halaman jenis dipilih, tampilkan title jenis
            elseif ($_GET['module']=='jenis' || $_GET['module']=='form_jenis') {
                echo "<title>Jenis Surat - Sistem Informasi Administrasi Surat Masuk dan Surat Keluar</title>";
            } 
        ...
        <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
            ...
            <footer class="footer footer-static footer-light navbar-border">
                <p class="clearfix text-muted text-sm-center mb-0 px-2">
                    <span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2024 - <a href="http://<?php echo $website; ?>" target="_blank" class="text-bold-500 grey darken-2"><?php echo $nama_instansi; ?></a></span>
