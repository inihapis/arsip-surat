...
<html lang="en" data-textdirection="ltr" class="loading">
    <head>
        ...
        <title>Login - Sistem Informasi Administrasi Surat Masuk dan Surat Keluar</title>
                        ...
                        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header no-border">
                                    <div class="card-title text-xs-center">
                                        <div class="p-1">
                                            ...
                                            <h4 style="margin-bottom:0">Sistem Informasi Manajemen Surat</h4>
                                ...
                                <div class="card-footer">
                                    <center>&copy; 2024 - <a href="http://<?php echo $website; ?>"><?php echo $nama_instansi; ?></a></center>
                                </div>
                            </div>
                        </div>
                    </section>
